...
export default function FirstBanner() {
    ...
    return (
        <>
                        ...
                        <path>
                            <animate
                                ...
                                values="
                                    ...
                                    M0.5 8.5C0.5 8.5 206.48 -49 339 140C424.5 220 409 110 564.5 270C707.77 370 766.98 260 881.5 470C994 600 1091.5 608.5 1091.5 608.5H0.5V8.5Z;
                                    M0.5 8.5C0.5 8.5 206.48 -55 339 122C424.5 200 409 122 564.5 259C707.77 350 766.98 283.88 881.5 433C994 579.5 1091.5 608.5 1091.5 608.5H0.5V8.5Z
                                "
                            />
                        </path>
            ...
            <Box sx={{
                backgroundImage: lg ? 'url(/about/thumbs_up_bkg.webp)' : 'none',
                height: sm ? 200 : 600,
